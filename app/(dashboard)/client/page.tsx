...
export default function ClientPage() {
  ...
  return (
    <section className="space-y-6">
      <header>
        <h1 className="text-2xl font-bold">Client — Track shipment</h1>
        <p className="text-slate-600">
          Enter a tracking number to see progress. Clients only see their own orders; admins can review all
          shipments for support.
        </p>
      </header>
