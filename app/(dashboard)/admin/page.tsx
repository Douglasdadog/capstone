  ...
  return (
    <section className="space-y-8">
      <div className="rounded-2xl border border-white/60 bg-white/80 p-6 shadow-sm backdrop-blur">
        ...
        <Link
          href="/admin/settings"
          className="mt-4 inline-block rounded-md bg-gradient-to-r from-blue-700 to-red-600 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-blue-400/30 transition-all hover:from-blue-800 hover:to-red-700"
        >
          Open Settings
        </Link>
      </div>
